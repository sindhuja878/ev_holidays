      ...
      <section id="services" className="py-32 relative overflow-hidden border-y border-white/5 bg-[#010801]">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Corporate Travel Destination" 
            referrerPolicy="no-referrer" 
          />
              ...
              return (
                <Link to={service.path} key={idx} className="block group">
                  <motion.div
                    ...
                    className="p-8 md:p-10 rounded-[2.5rem] shadow-2xl hover:shadow-[0_0_40px_rgba(20,107,10,0.3)] transition-all duration-500 relative overflow-hidden h-full flex flex-col bg-white/5 backdrop-blur-xl border border-white/10 group-hover:border-white/20"
                  >
                    {/* Default subtle warm glow for the background */}
                    <div className="absolute inset-0 bg-gradient-to-br from-white/[0.02] to-transparent pointer-events-none" />
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,_rgba(20,107,10,0.05),_transparent_60%)] pointer-events-none transition-opacity duration-500 group-hover:opacity-0" />
                    ...
                    <div className="flex justify-between items-start mb-6 relative z-10">
                      <div className="w-14 h-14 bg-white/5 rounded-[1.1rem] flex items-center justify-center border border-white/5 group-hover:bg-[#146b0a] group-hover:border-[#146b0a] transition-all duration-500">
                        <motion.div
                          animate={{ opacity: [1, 0.4, 1], scale: [1, 0.95, 1] }}
                        ...
                        >
                          <service.icon className="text-white w-6 h-6 transition-colors" />
                        </motion.div>
                      </div>
                      <span className="text-4xl font-black text-white/5 group-hover:text-[#146b0a]/20 transition-colors duration-500">{service.id}</span>
                    </div>
